...
class TranslationBuilder(object):
    ...
    def __init__(self, data, fields, n_best=1, replace_unk=False,
        ...
        self._has_coref_src = isinstance(
            dict(self.fields)["src"], CorefField)
        self.n_best = n_best
    ...
    def from_batch(self, translation_batch):
        ...
        preds, pred_score, attn, all_attn, gold_score, indices = list(zip(
            *sorted(zip(translation_batch["predictions"],
                        translation_batch["scores"],
                        translation_batch["attention"],
                        translation_batch["all_attention"],
        ...
        elif self._has_coref_src:
            src = batch.src[0][0][:, :, 0].data.index_select(1, perm)
        else:
            src = None
        ...
        for b in range(batch_size):
            ...
            translation = Translation(
                src[:, b] if src is not None else None,
                src_raw, pred_sents, attn[b], all_attn[b], pred_score[b],
...
class Translation(object):
    ...
    __slots__ = ["src", "src_raw", "pred_sents", "attns", "all_attns", "pred_scores",
                 "gold_sent", "gold_score"]

    def __init__(self, src, src_raw, pred_sents,
                 attn, all_attn, pred_scores, tgt_sent, gold_score):
        self.src = src
        self.src_raw = src_raw
        self.pred_sents = pred_sents
        self.attns = attn
        self.all_attns = all_attn
